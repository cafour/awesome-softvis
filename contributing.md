...
You'll need a [GitHub account](https://github.com/join)!s
...
[Here](https://github.com/RichardLitt/knowledge/blob/master/github/amending-a-commit-guide.md) is a write up on how to change a PR, and the different ways you can do that.
